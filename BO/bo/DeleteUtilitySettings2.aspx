...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div onkeydown="return (event.keyCode!=13)" id="div_set_schedule" style="width:360px; position:fixed; background-color:transparent; left:35%; top:28%; visibility:hidden; z-index:4500;" class="divTbl">
        <form action="GET" id="Form1" onsubmit="return (event.keyCode!=13);">

        <table id="Table2" class="tblLogMain" style="float:left; vertical-align:top; background-color:white; color:#1b2432; font-size:12px; height:auto; width:100%;" cellpadding="0" cellspacing="0">
            <tr>
                <th colspan="4">
            ...
            <tr>
                <td>
                    <table style="width:20%;float:left;margin-left:-10px;height:170px; font-weight:bold;">
                        <tr style="cursor:pointer;background-color:#BAD6FF;" id="btn_sch1" onclick="set_folder_schedule_window(this,1)"><td>Daily</td></tr>
                        <tr style="cursor:pointer;background-color:#BAD6FF;" id="btn_sch2" onclick="set_folder_schedule_window(this,2)"><td>Weekly</td></tr>
                        <tr style="cursor:pointer;background-color:#BAD6FF;" id="btn_sch3" onclick="set_folder_schedule_window(this,3)"><td>Fortnight</td></tr>
                        <tr style="cursor:pointer;background-color:#BAD6FF;" id="btn_sch4" onclick="set_folder_schedule_window(this,4)"><td>Monthly</td></tr>
                    </table>
                    <table style="width:80%;float:left;" id="tbl_schedule">
                        <tr id="tr_time" class="leftAlign" style="line-height:20px;font-size:12px;">
                            <td class="leftAlignSpace" style="padding-bottom:10px;padding-top:15px;">
                        ...
                        <tr id="tr_date" class="leftAlign" style="line-height:20px;font-size:12px;">
                            <td colspan="2" class="leftAlignSpace" style="padding-bottom:10px;">
                        ...
                        <tr id="trkeepFiles" class="leftAlign" style="line-height:20px;font-size:12px;">
                            <td colspan="2" class="leftAlignSpace" style="padding-bottom:10px;padding-top:5px;">
                                Keep Files for <input type="text" id="txt_schKeepFiles" style="width:40px; height:25px;"/> Days.
                            </td>
                        </tr>
                        ...
                        <tr id="trLast" style="line-height:20px;font-size:14px; text-align:center;">
                            <td colspan="2" class="leftAlignSpace dic_min_last_row">
