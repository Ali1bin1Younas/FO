    ...
    <form id="form1" runat="server">
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style=" font-family:Verdana; font-size:11px;">
            ...
            <tr style="height:20px;">
                ...
                <td>
                    <a runat="server" id="hrMT" href="#" target="_blank" style="text-decoration:none;">MT</a> | 
                    <a runat="server" id="hrQC" href="#" target="_blank" style="text-decoration:none;">QC</a> | 
                    <a runat="server" id="hrPR" href="#" target="_blank" style="text-decoration:none;">PR</a> | 
                    <a runat="server" id="hrFR" href="#" target="_blank" style="text-decoration:none;">FR</a>
                </td>
            </tr>
        </table>
     </form>
