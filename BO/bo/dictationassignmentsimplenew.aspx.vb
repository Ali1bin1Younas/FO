...
Partial Class BO_singleassign2
    ...
    Public Shared Function UpdateMT(ByVal dicIDs As String, ByVal uEmpID As String, ByVal workloadDate As Date) As String
        Try
            ...
            ConMT.saveDataValues("UPDATE boDictationLayers SET empID='" & uEmpID & "', diclWorkloadDate = '" & Format(workloadDate, "MM/dd/yyyy") & "'" _
                                 & " WHERE dicID IN (" & dicIDs & ") AND rolID = 'MT'")
            ConMT = Nothing
            Return "1"
        Catch ex As Exception
            Return ex.Message.ToString()
    ...
    Protected Shared Sub assignNextLayer(ByVal udicID As Long, ByVal vsFromRole As String, ByVal vsToRole As String, ByVal workLoadDate As Date)
    ...
    Protected Shared Sub assignPreviouseLayer(ByVal udicID As Long, ByVal vsFromRole As String, ByVal vsToRole As String, ByVal vsempID As String, ByVal workLoadDate As Date)
    ...
    <WebMethod> _
    <ScriptMethod> _
    Public Shared Function refresh_dictation(ByVal dicID As String) As String
        Try
            Dim Con As New MTBMS.DAL.DBTaskBO
            Dim Qry As String
