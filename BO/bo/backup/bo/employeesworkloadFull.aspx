                ...
                <DBWC:HierarGrid ID="EmpWorkload" SkinId="gridviewSkincolor" AutoGenerateColumns="False" runat="server"
                    ...
                    <columns>
                        ...
                        <asp:TemplateColumn HeaderText="Name">
                            <ItemStyle Width="395px" CssClass="tdspacingLeft" HorizontalAlign="Left" Font-Italic="False" Font-Size="8pt" Font-Strikeout="False" Font-Underline="False" Font-Overline="False" Font-Bold="True"></ItemStyle>
                            <ItemTemplate>
                                <%#Eval("empFirstName")%>&nbsp;<%#Eval("empLastName")%>
                            </ItemTemplate>

                            <HeaderStyle Width="395px" CssClass="gridHeadingLeft" HorizontalAlign="Left" Font-Italic="False" Font-Strikeout="False" Font-Underline="False" Font-Overline="False" Font-Bold="True" VerticalAlign="Middle"></HeaderStyle>
                        </asp:TemplateColumn>

                        <asp:TemplateColumn HeaderText="Specialty">
                            <HeaderStyle Width="110px" CssClass="gridHeadingLeft" HorizontalAlign="Left" Font-Italic="False" Font-Strikeout="False" Font-Underline="False" Font-Overline="False" Font-Bold="True" VerticalAlign="Middle"></HeaderStyle>
                        </asp:TemplateColumn>
