...
function Shift_queue_objs_bulk_assign() {
    if (queue.length > 0) {
        ...
        if (drID.id == "lblDrID") {
            ...
            var dicIDs = getAllTra_Ids(g_current_Grid, 4); // Cell 4 for MT
            if (dicIDs != "") {
                if (dicIDs_MainMT != "") {
            ...
            dicIDs = getAllTra_Ids(g_current_Grid, 5); // Cell 5 for QC
            if (dicIDs != "") {
                if (dicIDs_MainQC != "") {
            ...
            dicIDs = getAllTra_Ids(g_current_Grid, 6); // Cell 6 for PR
            if (dicIDs != "") {
                if (dicIDs_MainPR != "") {
            ...
            dicIDs = getAllTra_Ids(g_current_Grid, 7); // Cell 7 for FR
            if (dicIDs != "") {
                if (dicIDs_MainFR != "") {
                                ...
                                if (dicID_chk == temXml.find("dicID").text().trim()) {
                                    ...
                                    if (g_current_Grid.rows[index].cells.item(4).getElementsByTagName("span").length > 2) {
                                        ...
                                        if (temXml.find("diclStatus").text().trim() == 0) {
                                            ...
                                            g_current_Grid.rows[index].cells.item(4).getElementsByTagName("span")[1].style.color = "#F4BA00";
                                        } else if (temXml.find("diclStatus").text().trim() == 2) {
                                            g_current_Grid.rows[index].cells.item(4).getElementsByTagName("span")[1].style.color = "#7627FC";
                                        } else if (temXml.find("diclStatus").text().trim() == 3) {
                                            g_current_Grid.rows[index].cells.item(4).getElementsByTagName("span")[1].style.color = "#00804F";
                                        } else {
                                        ...
                                        if (temXml.find("diclStatus").text().trim() == 0) {
                                            ...
                                            g_current_Grid.rows[index].cells.item(4).getElementsByTagName("span")[0].style.color = "#F4BA00";
                                        } else if (temXml.find("diclStatus").text().trim() == 2) {
                                            g_current_Grid.rows[index].cells.item(4).getElementsByTagName("span")[0].style.color = "#7627FC";
                                        } else if (temXml.find("diclStatus").text().trim() == 3) {
                                            g_current_Grid.rows[index].cells.item(4).getElementsByTagName("span")[0].style.color = "#00804F";
                                        } else {
        ...
        for (i in elems) {
            if ((' ' + elems[i].className + ' ').indexOf(' ' + matchClass + ' ')
                ...
                if (obj.id == "chk_all_mt") {
                    g_current_Grid.rows[0].cells.item(4).getElementsByTagName("input")[0].checked = obj.checked;
                    checkAllDics(g_current_Grid.rows[0].cells.item(4).getElementsByTagName("input")[0], obj.checked);
