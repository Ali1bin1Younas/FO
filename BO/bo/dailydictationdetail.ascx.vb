...
Partial Class dailydictationdetail
    ...
    Private Function AddCounterInDataTable(ByVal dt As DataTable) As DataTable
    ...
    Protected Sub grdDailyProgress_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdDailyProgress.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            If e.Row.RowIndex Mod 2 = 0 Then
                e.Row.BackColor = System.Drawing.Color.FromName("rgb(189, 212, 245)")
            End If
        End If
    End Sub
