...
Partial Class BO_singleassign2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Me.IsPostBack Then
            ...
            Me.CPDateMT.SelectedDate = Now
            Me.CPDateMT.VisibleDate = Now

            Me.CPDateQC.SelectedDate = Now
            Me.CPDateQC.VisibleDate = Now

            Me.CPDatePR.SelectedDate = Now
            Me.CPDatePR.VisibleDate = Now

            Me.CPDateFR.SelectedDate = Now
            Me.CPDateFR.VisibleDate = Now
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        If Format(CPMain.SelectedDate, "MM/dd/yyyy") Is Nothing Then
            Me.CPDateMT.SelectedDate = Me.CPMain.SelectedDate
            Me.CPDateMT.VisibleDate = Me.CPMain.SelectedDate

            Me.CPDateQC.SelectedDate = Me.CPMain.SelectedDate
            Me.CPDateQC.VisibleDate = Me.CPMain.SelectedDate

            Me.CPDatePR.SelectedDate = Me.CPMain.SelectedDate
            Me.CPDatePR.VisibleDate = Me.CPMain.SelectedDate

            Me.CPDateFR.SelectedDate = Me.CPMain.SelectedDate
            Me.CPDateFR.VisibleDate = Me.CPMain.SelectedDate
        End If
        ...
        If e.Row.RowType = DataControlRowType.DataRow And Me.BtnClick Then
            ...
            Else
                ...
                If Con.getScalar(Qry) > 0 Then
                    ...
                    imgDuplicateCheck.Enabled = True
    ...
    Private Sub UpdateMT(ByVal udicID As Long, ByVal uEmpID As String)
        ...
        ConMT.saveDataValues("UPDATE boDictationLayers SET empID='" & uEmpID & "', diclWorkloadDate = '" & Format(CPDateMT.SelectedDate, "MM/dd/yyyy") & "'" _
    ...
    Private Sub UpdateLayer(ByVal udicID As Long, ByVal vsrolID As String, ByVal uEmpID As String)
        ...
        If intStatus = 2 Or intStatus = 3 Then Exit Sub
        If uEmpID = "Skipped" Then uEmpID = "0"

        If intStatus = 0 Then

            If vsrolID = "QC" Then
                strQry = "UPDATE boDictationLayers SET empID = '" & uEmpID & "', diclWorkloadDate = '" & Format(CPDateQC.SelectedDate, "MM/dd/yyyy") & "', " _
                     & "diclSkip = " & IIf(uEmpID = "0", 1, 0) & " " _
                     & "WHERE dicID = " & udicID & " AND rolID = '" & vsrolID & "'"
            ElseIf vsrolID = "PR" Then
                strQry = "UPDATE boDictationLayers SET empID = '" & uEmpID & "', diclWorkloadDate = '" & Format(CPDatePR.SelectedDate, "MM/dd/yyyy") & "', " _
                     & "diclSkip = " & IIf(uEmpID = "0", 1, 0) & " " _
                     & "WHERE dicID = " & udicID & " AND rolID = '" & vsrolID & "'"
            ElseIf vsrolID = "FR" Then
                strQry = "UPDATE boDictationLayers SET empID = '" & uEmpID & "', diclWorkloadDate = '" & Format(CPDateFR.SelectedDate, "MM/dd/yyyy") & "', " _
                     & "diclSkip = " & IIf(uEmpID = "0", 1, 0) & " " _
                     & "WHERE dicID = " & udicID & " AND rolID = '" & vsrolID & "'"
            End If
    ...
    Protected Sub assignNextLayer(ByVal udicID As Long, ByVal vsFromRole As String, ByVal vsToRole As String)
        ...
        If dsLL.Tables(0).Rows.Count > 0 Then
            ...
            If iRecordsEffected > 0 Then
                ...
                If vsToRole = "QC" Then
                    strQry = "UPDATE boDictationLayers SET empID = '0', diclWorkloadDate = '" & Format(CPDateQC.SelectedDate, "MM/dd/yyyy") & "', " _
                         & "diclTranscriptions = " & iRecordsEffected & ", " _
                         & "diclSkip = 1, diclStatus = 1 "
                ElseIf vsToRole = "PR" Then
                    strQry = "UPDATE boDictationLayers SET empID = '0', diclWorkloadDate = '" & Format(CPDatePR.SelectedDate, "MM/dd/yyyy") & "', " _
                         & "diclTranscriptions = " & iRecordsEffected & ", " _
                         & "diclSkip = 1, diclStatus = 1 "
                ElseIf vsToRole = "FR" Then
                    strQry = "UPDATE boDictationLayers SET empID = '0', diclWorkloadDate = '" & Format(CPDateFR.SelectedDate, "MM/dd/yyyy") & "', " _
                         & "diclTranscriptions = " & iRecordsEffected & ", " _
                         & "diclSkip = 1, diclStatus = 1 "
                End If
    ...
    Protected Sub assignPreviouseLayer(ByVal udicID As Long, ByVal vsFromRole As String, ByVal vsToRole As String, ByVal vsempID As String)
        ...
        If dsLL.Tables(0).Rows.Count > 0 Then
            ...
            If iRecordsEffected > 0 Then
                ...
                If vsToRole = "QC" Then
                    strQry = "UPDATE boDictationLayers SET diclTranscriptions = 0, diclWorkloadDate = '" & Format(CPDateQC.SelectedDate, "MM/dd/yyyy") & "', " _
                         & "diclSkip = 0, diclStatus = 1, empID = '" & vsempID & "' " _
                         & "WHERE dicID = " & udicID & " AND rolID = '" & vsToRole & "'"
                ElseIf vsToRole = "PR" Then
                    strQry = "UPDATE boDictationLayers SET diclTranscriptions = 0, diclWorkloadDate = '" & Format(CPDatePR.SelectedDate, "MM/dd/yyyy") & "', " _
                        & "diclSkip = 0, diclStatus = 1, empID = '" & vsempID & "' " _
                        & "WHERE dicID = " & udicID & " AND rolID = '" & vsToRole & "'"
                ElseIf vsToRole = "FR" Then
                    strQry = "UPDATE boDictationLayers SET diclTranscriptions = 0, diclWorkloadDate = '" & Format(CPDateFR.SelectedDate, "MM/dd/yyyy") & "', " _
                        & "diclSkip = 0, diclStatus = 1, empID = '" & vsempID & "' " _
                        & "WHERE dicID = " & udicID & " AND rolID = '" & vsToRole & "'"
                End If
