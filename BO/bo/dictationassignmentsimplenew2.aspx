        ...
        <Columns>
            <asp:TemplateField HeaderText="Work Load Detail">
                ...
                <table id="tbl_dictator_detail_main" width="100%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table id="tblDictatorDetail" class="tblDictatorDetail">
                                <tr style="background-color:#bad6ff; font-weight: bold">
                                    ...
                                    <td align="left" style="font-family: Verdana; font-size:10pt; padding-left:5px; width: 230px; color: black; height:30px;">
                                        ...
                                        <label id="lblDrID" class="tooltip_p" onmouseover="getDrRols(this,<%#Eval("drID")%>)"><%#Eval("drID")%></label>&nbsp;-&nbsp;
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:GridView ID="GridView1" runat="server" OnRowCreated="GridView1_RowCreated" OnRowCommand="GridView1_RowCommand" DataKeyNames="dicID,dicActualName,dicLength,dicDuplicateCheck,dicUrgent,dicTempName"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="" HeaderStyle-HorizontalAlign="center">
                                        <ItemStyle Width="30px" />
                                        <ItemTemplate>
                                            <asp:HyperLink runat="server" ID="btnPlayDic" ImageUrl="~/Icon/play.png" />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="center" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Options" HeaderStyle-CssClass="gridHeadingCenter">
                                        <ItemStyle Width="140px" HorizontalAlign="right" CssClass="tdSpacingRightOptions"/>
                                        <ItemTemplate>
    ...
    <div onkeydown="return (event.keyCode!=13)" style="width:550px; position:fixed; background-color:transparent; left:30%; top:28%; visibility:hidden; z-index:999999;" class="divTbl" id="divTbl">
        <table id="tblLogMain" class="tblLogMain" style="vertical-align:top; background-color:white; color:#1b2432; font-size:12px; height:auto; width:100%;" cellpadding="0" cellspacing="0">
            ...
            <tr class="leftAlign" style="line-height:20px;font-size:14px;">
                <td class="leftAlignSpace"><span style="font-weight:bold">Client ID:</span> <label id="lblViewTransCliID"></label></td>
                <td class="leftAlignSpace leftAlign"><span style="font-weight:bold">Name:</span> <label id="lblViewTransCliName" ></label></td>
            </tr>
            ...
            <tr><td colspan="2"  style="margin-bottom:10px;background-color:black;height:1px; width:270px;"></td></tr>
                <tr class="leftAlign" style="line-height:15px;font-size:14px;">
                    <td class="leftAlignSpace"><span style="font-weight:bold">Notes to Secretary:</span><label id="lblViewNTS"></label></td>
            ...
            <tr><td colspan="2"  style="margin-bottom:10px;background-color:black;height:1px; width:270px;"></td></tr>
            <tr class="leftAlign" style="line-height:20px;font-size:14px;">
                <td class="leftAlignSpace"><span style="font-weight:bold">Account:</span> <label id="lblViewTransHosName"></label></td>
                <td class="leftAlignSpace"><span style="font-weight:bold">Dic Name:</span> <label id="lblViewTransDicName"></label></td>
                <%--<td class="leftAlignSpace">Tra. Uploaded: <label id="lblDicMMUploadDate"></label></td>--%>
            </tr>
            <tr><td colspan="2"  style="margin-bottom:10px;background-color:black;height:1px; width:270px;"></td></tr>
            <tr>
