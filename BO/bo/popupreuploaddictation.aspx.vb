...
Imports MTBMS.DAL
Imports MTBMS.BLL
Partial Class BO_popupreuploaddictation
    ...
    Dim str As String = "<table width=500 border=0 cellpadding=0 cellspacing=0>" _
                           ...
                           + "<td align=center width=80><img src='../images/info.ico'></td><td align=left width=370><font style='font-size:8pt;'>File In Process so that's why can't Reuploade</font></td></tr><tr><td colspan=2 height=6></td></tr></table></fieldset></td></tr>" _
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            ...
            If checkStatus = 4 Then
                Me.btnReupload.Enabled = True
                Me.lblInformation.Text = ""
            Else
                Me.btnReupload.Enabled = False
    ...
    Protected Sub btnReupload_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReupload.Click
        Try
            If Me.cbLinecount.Checked Then
                Qry = "UPDATE boDictation set dicStatus=3 where dicId=" & dicId & ";"
                Qry += "UPDATE boTranscription set traStatus=2 where dicId=" & dicId
            Else
                Qry = "UPDATE boDictation set dicStatus=2 where dicId=" & dicId & ";"
                Qry += "UPDATE boTranscription set traStatus= 1,traCharacters= -1 where dicId=" & dicId
            End If
            Con.saveData(Qry)
            GF.Refresh = 2
            Dim str As String
