...
Public Class temp
    ...
    <WebMethod()> _
    Public Function downloadedComparisonsUpdate(ByVal empID As String, ByVal tralIDs As String) As Boolean
        Dim con As New DBTaskBO
        Dim Qry As String = "UPDATE boTranscriptionLayers SET tralComparison = 2 WHERE tralID IN('" & tralIDs & "')"
