...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table border="0" cellspacing="0" cellpadding="0" width ="980">
      <tr>
            ...
            <tr><td align="left" class="headingLrg"><br style="line-height:20px;"/><Strong>Assign Dictator Team</Strong></td></tr>
         </table></td>
        </tr>
    <tr>
    <td style="text-align: right" valign="middle" height ="25px" >
        <asp:DropDownList ID="cmbMT" runat="server" Width="140px" Height="19px">
        </asp:DropDownList><asp:DropDownList ID="cmbQC" runat="server" Width="139px" Height="19px">
        </asp:DropDownList><asp:DropDownList ID="cmbPR" runat="server" Width="139px" Height="19px">
        </asp:DropDownList><asp:DropDownList ID="cmbFR" runat="server" Width="139px" Height="19px"></asp:DropDownList>
        <asp:Button ID="btnAssign" runat="server" Text="Assign" Width="53px" />&nbsp;
        </td>   
    </tr>
