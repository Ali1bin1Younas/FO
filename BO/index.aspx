<%@ Page Language="VB" AutoEventWireup="false" CodeFile="index.aspx.vb" Inherits="bologin" %>
...
<form id="form2" runat="server">
  <table width="770" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td style="padding:30px; text-align:center;"><img src="images/BOloginpageHeading.jpg" width="195" height="24" /></td>
    </tr>
    <tr>
      <td><table width="770" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><img src="images/spacer.gif" width="59" height="1" /></td>
            <td valign="top" align="center"><table width="311" border="0" cellspacing="0" cellpadding="0">
                <tr>
                ...
                <tr>
                  <td bgcolor="#EFF0F2" align="center"><table width="230" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td class="divide">&nbsp;</td>
                        <td class="alinLeft" style="height: 22px"><asp:TextBox ID="txtboID" runat="server" cssclass="txtfieldStyle" Width="149px"></asp:TextBox>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td colspan="3" class="tdalignRight" >&nbsp;</td>
                      </tr>
                      <tr>
    ...
    <tr>
      <td class="footerBackground" valign="top"><br style="line-height:5px;"/>
        <font class="copyright">Copyright &copy; 2014 Accesstek (Pvt.) Ltd. All Rights Reserved.</font></td>
    </tr>
  </table>
</form>
</center>
